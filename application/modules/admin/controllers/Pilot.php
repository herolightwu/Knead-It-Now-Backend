...
class Pilot extends Admin_Controller {
	...
	public function index()
	{
		...
		$crud->columns('photo', 'username', 'email', 'phone', 'home_addr', 'work_addr', 'active');
		...
		$crud->display_as('home_addr','Home Address');
		$crud->display_as('work_addr','Work Address');
